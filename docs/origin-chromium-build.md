...
_Optional_: You can also [install API
...
to generate `.ninja` files. You can create any number of _build directories_
...
you are probably running out of memory when linking. You _must_ use a 64-bit
